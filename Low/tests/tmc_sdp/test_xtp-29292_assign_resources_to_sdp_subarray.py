...
from resources.test_harness.helpers import update_eb_pb_ids
from resources.test_harness.utils.common_utils import (
...
@pytest.mark.tmc_sdp
@scenario(
    "../features/tmc_sdp/xtp-29292_assign_resources_to_sdp_subarray.feature",
